...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet-snippets python-mode py-autopep8 markdown-mode hiwin golden-ratio git-gutter-fringe elm-mode dumb-jump dockerfile-mode cmake-mode auto-complete))))
(custom-set-faces
